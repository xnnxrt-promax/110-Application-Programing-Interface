...
app.get('/api', (req, res) => {
    res.json({
        ...
        des5: 'โค้ดที่เราแจกฟรีจะเป็น open src ส่วนใหญ่โดยเราจะไม่แจกเป็นไฟล์ exe หรือฝังโค้ดดักแน่นอนครับ ถ้าไม่ได้แจกเป็น src แสดงว่าอาจจะจำเป็นต้องใช้ api ของทางเราซึ่งไม่สามารถเปิดเผยได้เพราะเป็นข้อมูลลับหากไม่สบายใจให้เปิด Anti-Virus หรือเช็คไฟล์ก่อนเปิดไฟล์หากยังไม่สามารถทำให้ท่านสบายใจได้ท่านสามารถคิดได้ด้วยตัวเองว่าจะดาวโหลดหรือไม่ (กรุณาใช้สมองไต่ตรอง)'
    });
});
